...
class Samus(nn.Module):
    ...
    def __init__(
        ...
        for n, value in self.image_encoder.named_parameters():
          if "cnn_embed" not in n and "post_pos_embed" not in n and "Adapter" not in n and "2.attn.rel_pos" not in n and "5.attn.rel_pos" not in n and "8.attn.rel_pos" not in n and "neck" not in n and "11.attn.rel_pos" not in n and "iAFF" not in n and "CGA"not in n and "dropout" not in n and "Bi_Adapter" not in n and "hff" not in n and "upneck" not in n:
